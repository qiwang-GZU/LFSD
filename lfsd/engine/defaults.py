...
from lfsd.data import *
from lfsd.modeling import build_model
from lfsd.engine.hooks import EvalHookDeFRCN
from lfsd.checkpoint import DetectionCheckpointer
from lfsd.solver import build_lr_scheduler, build_optimizer
from lfsd.evaluation import DatasetEvaluator, DatasetEvaluators, inference_on_dataset, print_csv_format, verify_results
from lfsd.dataloader import MetadataCatalog, build_detection_test_loader, build_detection_train_loader
...
def default_setup(cfg, args):
    ...
    setup_logger(output_dir, distributed_rank=rank, name="lfsd")
...
class DefaultTrainer(SimpleTrainer):
    ...
    def resume_or_load(self, resume=True):
        ...
        if resume:
            ...
            # Fine-tuning from pretrained weights: always start from iteration 0
            self.start_iter = 0
    ...
    def build_model(cls, cfg):
        ...
        It now calls :func:`lfsd.modeling.build_model`.
    ...
    def build_optimizer(cls, cfg, model):
        ...
        It now calls :func:`lfsd.solver.build_optimizer`.
    ...
    def build_lr_scheduler(cls, cfg, optimizer):
        """
        It now calls :func:`lfsd.solver.build_lr_scheduler`.
    ...
    def build_train_loader(cls, cfg):
        ...
        It now calls :func:`lfsd.data.build_detection_train_loader`.
    ...
    def build_test_loader(cls, cfg, dataset_name):
        ...
        It now calls :func:`lfsd.data.build_detection_test_loader`.
        Overwrite it if you'd like a different data loader.
        """
...
class Trainer(DefaultTrainer):
    ...
    def build_evaluator(cls, cfg, dataset_name, output_folder=None):
        ...
        if evaluator_type == "coco":
            from lfsd.evaluation import COCOEvaluator
            evaluator_list.append(COCOEvaluator(dataset_name, True, output_folder))
        if evaluator_type == "pascal_voc":
            from lfsd.evaluation import PascalVOCDetectionEvaluator
