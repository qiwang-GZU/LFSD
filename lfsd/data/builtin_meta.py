...
BCGD_CATEGORIES = [
    {"id": 1, "name": "Platelets", "color": [230, 57, 70]},
    {"id": 2, "name": "RBC", "color": [29, 111, 182]},
    {"id": 3, "name": "WBC", "color": [67, 170, 139]},
]


def _get_bcgd_fewshot_instances_meta():
    thing_ids = [k["id"] for k in BCGD_CATEGORIES]
    thing_classes = [k["name"] for k in BCGD_CATEGORIES]
    color_map = [k["color"] for k in BCGD_CATEGORIES]
    dataset_id_to_contiguous_id = {thing_id: idx for idx, thing_id in enumerate(thing_ids)}
    return {
        "thing_classes": thing_classes,
        "thing_colors": color_map,
...
def _get_builtin_metadata(dataset_name):
    ...
    elif dataset_name == "bcgd_fewshot":
        return _get_bcgd_fewshot_instances_meta()
